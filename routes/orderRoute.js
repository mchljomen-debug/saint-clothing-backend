...
orderRouter.post("/create-paymongo-checkout",authUser,createPaymongoCheckout);
orderRouter.post("/payment-status",authUser,getPaymentStatus);
orderRouter.post("/submit-payment-proof",authUser,upload.single("paymentProofImage"),submitPaymentProof);
orderRouter.post("/userorders",authUser,userOrders);
orderRouter.post("/receive",authUser,upload.single("deliveryProofImage"),receiveOrder);
